# ESP32 Receiver - Upload Script
# Run this to upload the receiver code to your ESP32

$PIO = "C:\Users\bassm\.platformio\penv\Scripts\platformio.exe"

Write-Host "================================================" -ForegroundColor Cyan
Write-Host "  ESP32 AIS Receiver - Upload & Monitor" -ForegroundColor Cyan
...
& $PIO run --target upload --target monitor --upload-port COM8
